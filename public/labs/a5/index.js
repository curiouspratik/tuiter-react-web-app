...
console.log("%cParenthesis and parameters%c", bold, normal);
const square = a => a * a;
const plusOne = a => a + 1;
...
console.log("%cArrays%c", bold, normal);
...
console.log("%cArray index and length%c", bold, normal);
const length1 = numberArray1.length;
const index1 = numberArray1.indexOf(3);
console.log(length1);
console.log(index1);

console.log("%cAdd and remove data to arrays%c", bold, normal);
// adding new items
numberArray1.push(6);
...
console.log("%cFor loops%c", bold, normal);
for (let i=0; i<stringArray1.length; i++) {
  const string1 = stringArray1[i];
  console.log(string1);
}

console.log("%cMap Function%c", bold, normal);
const squares = numberArray1.map(square);
const cubes = numberArray1.map(a => a * a * a);
console.log(squares);
console.log(cubes);

console.log("%cFind Function%c", bold, normal);
const four = numberArray1.find(a => a === 4);
const string3 = stringArray1.find(a => a === 'string3');
console.log(four);
console.log(string3);

console.log("%cFind index%c", bold, normal);
...
console.log("%cFilter Function%c", bold, normal);
...
console.log("%cTemplate string%c", bold, normal);
const five = 2 + 3;
